...
package net.doubledoordev.libs.javazoom.jl.player.advanced;

import java.io.InputStream;

import net.doubledoordev.libs.javazoom.jl.decoder.Bitstream;
import net.doubledoordev.libs.javazoom.jl.decoder.BitstreamException;
import net.doubledoordev.libs.javazoom.jl.decoder.Decoder;
import net.doubledoordev.libs.javazoom.jl.decoder.Header;
import net.doubledoordev.libs.javazoom.jl.decoder.JavaLayerException;
import net.doubledoordev.libs.javazoom.jl.decoder.SampleBuffer;
import net.doubledoordev.libs.javazoom.jl.player.AudioDevice;
import net.doubledoordev.libs.javazoom.jl.player.FactoryRegistry;

/**
 * a hybrid of net.doubledoordev.libs.javazoom.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
