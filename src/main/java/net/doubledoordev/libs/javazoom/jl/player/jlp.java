...
public class jlp
{
    ...
    public void showUsage()
    {
        ...
        System.out.println("");
        System.out.println(" e.g. : java net.doubledoordev.libs.javazoom.jl.player.jlp localfile.mp3");
        System.out.println("        java net.doubledoordev.libs.javazoom.jl.player.jlp -url http://www.server.com/remotefile.mp3");
        System.out.println("        java net.doubledoordev.libs.javazoom.jl.player.jlp -url http://www.shoutcastserver.com:8000");
    }
