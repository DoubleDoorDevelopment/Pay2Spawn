...
package net.doubledoordev.pay2spawn.util.javazoom.jl.player.advanced;

import net.doubledoordev.pay2spawn.util.javazoom.jl.decoder.*;
import net.doubledoordev.pay2spawn.util.javazoom.jl.player.AudioDevice;
import net.doubledoordev.pay2spawn.util.javazoom.jl.player.FactoryRegistry;

import java.io.InputStream;

/**
 * a hybrid of net.doubledoordev.pay2spawn.util.javazoom.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
